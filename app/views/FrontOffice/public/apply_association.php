            ...
            <section class="relative pt-52 xs:pt-40 pb-16 md:pb-24 lg:pb-52 bg-orange-50 overflow-hidden">
                ...
                <div class="container mx-auto px-4 relative">
                    <div class="max-w-sm mx-auto">
                        ...
                        <h3  class="mb-6 font-bold">Apply for Association </h3>
<br>
                        <form action="apply_association_process.php" method="POST" enctype="multipart/form-data">
                            <label>name : </label>
                            <input type="text" name="text" value="<?= htmlspecialchars($_SESSION['user_name']); ?>" disabled><br><br>

                            <label>Upload Patente Image :</label><br>
                            <input type="file" name="patente" required><br><br>

                            <button class="h-12 inline-flex mt-3 py-1 px-5 items-center justify-center font-medium text-teal-900 border border-lime-500 hover:border-white bg-lime-500 hover:bg-white rounded-full transition duration-200"

...
$user = $controller->getUserById($user_id); // on va créer cette méthode dans le contrôleur
...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if(!$errors){
        ...
        if($controller->updateUser($user_id, $name, $email, $address, $hashedPassword)){
            $success = "Profile updated successfully!";
            $_SESSION['user_name'] = $name; // mettre à jour session
            $user = $controller->getUserById($user_id); // rafraîchir les données
        } else {
  ...
  <div>
      ...
      <section class="overflow-hidden" x-data="{ mobileNavOpen: false }">
        <nav class="mx-4 py-6 border-b">
          <div class="container mx-auto px-4">
            <div class="relative flex items-center justify-between"><a class="inline-block" href="index.php"><img
                  class="h-8" src="images/logo.png" alt="" /></a>
    ...
    <?php endif; ?>
              ...
              <div class="flex items-center justify-end">
                <div class="hidden md:block">
                  <div class="hidden md:block"><a
                      class="inline-flex py-2.5 px-4 mr-3 lg:mr-4 items-center justify-center text-sm font-medium text-teal-900 hover:text-white border border-teal-900 hover:bg-teal-900 rounded-full transition duration-200"
                ...
                <button class="md:hidden text-teal-900 hover:text-teal-800" x-on:click="mobileNavOpen = !mobileNavOpen">
                  <svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5.19995 23.2H26.7999" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round"></path>
                    <path d="M5.19995 16H26.7999" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round"></path>
                    <path d="M5.19995 8.79999H26.7999" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round"></path>
                  </svg>
                </button>
              </div>
        ...
        <div class="hidden fixed top-0 left-0 bottom-0 w-full xs:w-5/6 xs:max-w-md z-50"
          ...
          <nav class="relative flex flex-col py-7 px-10 w-full h-full bg-white overflow-y-auto">
            <div class="flex items-center justify-between"><a class="inline-block" href="#!"><img class="h-8"
                  src="fauna-assets/logos/logo.png" alt="" /></a>
              <div class="flex items-center"><a
                  class="inline-flex py-2.5 px-4 items-center justify-center text-sm font-medium text-teal-900 hover:text-white border border-teal-900 hover:bg-teal-900 rounded-full transition duration-200"
                  href="#!">Login</a>
            ...
            <div class="pt-20 pb-12 mb-auto">
              <ul class="flex-col">
                <li class="mb-6"><a class="inline-block text-teal-900 hover:text-teal-700 font-medium" href="">home</a>
                </li>
            ...
            <div class="flex items-center justify-between"><a
                class="inline-flex items-center text-lg font-medium text-teal-900" href="#!"><span>
                  <svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      stroke="#646A69" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path d="M28 8.8L16 17.2L4 8.8" stroke="#646A69" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round"></path>
   ...
   <section class="relative pt-52 xs:pt-40 pb-16 md:pb-24 lg:pb-52 bg-orange-50 overflow-hidden">
        ...
        <p class="absolute top-0 right-0 mt-32 xs:mt-12 mr-5">
          ...
          <a class="inline-block font-medium underline hover:text-lime-600" href="login.php">Login</a>
        </p>
...
<form method="POST">
    <h3 class="text-4xl text-center font-medium mb-10">gerer profile</h3>

    <label class="block pl-4 mb-1 text-sm font-medium" for="name">Full name</label>
    <input class="w-full px-4 py-3 mb-2 outline-none focus:ring-2 focus:ring-lime-500 shadow rounded-full"  type="text" name="name" value="<?= htmlspecialchars($user['name']) ?>" />
    <?php if(isset($errors['name'])) echo '<p>'.$errors['name'].'</p>'; ?>

    <label class="block pl-4 mb-1 text-sm font-medium" for="email">Email</label>
  <input class="w-full px-4 py-3 mb-2 outline-none focus:ring-2 focus:ring-lime-500 shadow rounded-full" 
          type="email" name="email" value="<?= htmlspecialchars($user['email']) ?>" />
    <?php if(isset($errors['email'])) echo '<p>'.$errors['email'].'</p>'; ?>

    <label class="block pl-4 mb-1 text-sm font-medium" for="address">Address</label>
  <input class="w-full px-4 py-3 mb-2 outline-none focus:ring-2 focus:ring-lime-500 shadow rounded-full" 
         type="text" name="address" value="<?= htmlspecialchars($user['address']) ?>" />
    <?php if(isset($errors['address'])) echo '<p>'.$errors['address'].'</p>'; ?>

    <label class="block pl-4 mb-1 text-sm font-medium" for="password">Password (leave blank to keep current):</label>
  <input class="w-full px-4 py-3 mb-6 outline-none focus:ring-2 focus:ring-lime-500 shadow rounded-full" 
         type="password" name="password" />

         <button type="submit"
          class="inline-flex w-full py-3 px-6 items-center justify-center text-lg font-medium text-white bg-teal-900 hover:bg-lime-500 hover:text-black border border-teal-900 hover:border-lime-500 rounded-full transition duration-200">
    ...
    <!-- Footer Section -->
    <section class="relative py-12 lg:py-24 bg-orange-50 overflow-hidden">
      <img class="absolute bottom-0 left-0" src="fauna-assets/footer/waves-lines-left-bottom.png" alt="" />
      <div class="container px-4 mx-auto relative">
        <div class="flex flex-wrap mb-16 -mx-4">
          ...
          <div class="w-full md:w-7/12 lg:w-6/12 px-4 mb-16 lg:mb-0">
            <div class="flex flex-wrap -mx-4">
              <div class="w-1/2 xs:w-1/3 px-4 mb-8 xs:mb-0">
                ...
                <ul>
                  <li class="mb-4">
                    <a class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#!">Solutions</a>
                  </li>
                  <li class="mb-4">
                    <a class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#!">How it works</a>
                  </li>
                  <li>
                    <a class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#!">Pricing</a>
                  </li>
                </ul>
              </div>
              <div class="w-1/2 xs:w-1/3 px-4 mb-8 xs:mb-0">
                ...
                <ul>
                  <li class="mb-4">
                    <a class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#!">Blog</a>
                  </li>
                  <li class="mb-4">
                    <a class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#!">Help Center</a>
                  </li>
                  <li>
                    <a class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#!">Support</a>
                  </li>
                </ul>
              </div>
              <div class="w-full xs:w-1/3 px-4">
                ...
                <ul>
                  <li class="mb-4">
                    <a class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#!">About</a>
                  </li>
                  <li class="mb-4">
                    <a class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#!">Our Mission</a>
                  </li>
                  <li class="mb-4">
                    <a class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#!">Careers</a>
                  </li>
                  <li>
                    <a class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#!">Contact</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="w-full md:w-5/12 lg:w-4/12 px-4">
            <div class="max-w-sm p-8 bg-teal-900 rounded-2xl mx-auto md:mr-0">
              ...
              <p class="text-sm text-white opacity-80 leading-normal mb-10">Stay in the loop with our Green Horizon
                newsletter, where we deliver bite-sized insights into the latest green energy solutions.</p>
              <div class="flex flex-col">
                <input
                  class="h-12 w-full px-4 py-1 placeholder-gray-700 outline-none ring-offset-0 focus:ring-2 focus:ring-lime-500 shadow rounded-full"
                  type="email" placeholder="Your e-mail..." />
                <a
                  class="h-12 inline-flex mt-3 py-1 px-5 items-center justify-center font-medium text-teal-900 border border-lime-500 hover:border-white bg-lime-500 hover:bg-white rounded-full transition duration-200"
                  href="#!">Get in touch</a>
              </div>
            </div>
          </div>
        ...
        <div class="flex flex-wrap -mb-3 justify-between">
          <div class="flex items-center mb-3">
            <a class="inline-block mr-4 text-black hover:text-lime-500" href="#!">
              <svg width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a class="inline-block text-black hover:text-lime-500" href="#!">
              <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M19 3C19.5304 3 20.0391 3.21071 20.4142 3.58579C20.7893 3.96086 21 4.46957 21 5V19C21 19.5304 20.7893 20.0391 20.4142 20.4142C20.0391 20.7893 19.5304 21 19 21H5C4.46957 21 3.96086 20.7893 3.58579 20.4142C3.21071 20.0391 3 19.5304 3 19V5C3 4.46957 3.21071 3.96086 3.58579 3.58579C3.96086 3.21071 4.46957 3 5 3H19ZM18.5 18.5V13.2C18.5 12.3354 18.1565 11.5062 17.5452 10.8948C16.9338 10.2835 16.1046 9.94 15.24 9.94C14.39 9.94 13.4 10.46 12.92 11.24V10.13H10.13V18.5H12.92V13.57C12.92 12.8 13.54 12.17 14.31 12.17C14.6813 12.17 15.0374 12.3175 15.2999 12.5801C15.5625 12.8426 15.71 13.1987 15.71 13.57V18.5H18.5ZM6.88 8.56C7.32556 8.56 7.75288 8.383 8.06794 8.06794C8.383 7.75288 8.56 7.32556 8.56 6.88C8.56 5.95 7.81 5.19 6.88 5.19C6.43178 5.19 6.00193 5.36805 5.68499 5.68499C5.36805 6.00193 5.19 6.43178 5.19 6.88C5.19 7.81 5.95 8.56 6.88 8.56ZM8.27 18.5V10.13H5.5V18.5H8.27Z"
                  fill="currentColor"></path>
          ...
          <div class="text-center">
            Created by 
            <a class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="https://www.pixelrocket.store" target="_blank">Pixelrocket</a>
            <span> • Distributed by </span>
            <a class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="https://www.ThemeWagon.store" target="_blank">ThemeWagon</a>
          </div>

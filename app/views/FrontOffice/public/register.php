...
include('C:\xampp\htdocs\projet_web\app\controllers\FrontOfficeController.php');

$errors = [];
$frontController = new FrontOfficeController();
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!$errors) {
       ...
       $role='user';
        ...
        if ($frontController->adduser($user)) {
            header("Location: register.php?success=1");
            exit;
        } else {
            $errors['general'] = "Error creating your account.";
        }
    }
}
?>
...
<script>
  document.querySelector("form").addEventListener("submit", function (e) {
    ...
    function showError(inputId, message) {
      ...
      error.classList = "text-red-500 text-sm mt-1 mb-4 js-error";
      error.textContent = message;
      input.insertAdjacentElement("afterend", error);
    }

    // Nom : lettres + espaces seulement

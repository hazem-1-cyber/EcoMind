...
<body class="antialiased bg-body text-body font-body">
  <div>
    ...
    <section class="relative pt-52 xs:pt-40 pb-16 md:pb-24 lg:pb-52 bg-orange-50 overflow-hidden"><a
        class="absolute top-0 left-0 ml-5 mt-12 inline-block" href="#!">
        <svg width="40" height="40" viewbox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect x="28.8392" y="9.98291" width="1.66667" height="10" rx="0.833333" transform="rotate(45 28.8392 9.98291)"
            fill="#022C22"></rect>
          <rect x="17.0537" y="21.7678" width="1.66667" height="10" rx="0.833333" transform="rotate(45 17.0537 21.7678)"
            fill="#022C22"></rect>
          <rect x="23.3335" y="20.8333" width="1.66667" height="10" rx="0.833333"
            transform="rotate(-90 23.3335 20.8333)" fill="#022C22"></rect>
          <rect x="6.66638" y="20.8333" width="1.66667" height="10" rx="0.833333"
            transform="rotate(-90 6.66638 20.8333)" fill="#022C22"></rect>
          <rect x="21.7677" y="22.9463" width="1.66667" height="10" rx="0.833333"
            transform="rotate(-45 21.7677 22.9463)" fill="#022C22"></rect>
          <rect x="9.98267" y="11.1611" width="1.66667" height="10" rx="0.833333"
            transform="rotate(-45 9.98267 11.1611)" fill="#022C22"></rect>
        </svg></a>
      <p class="absolute top-0 right-0 mt-32 xs:mt-12 mr-5"><span>New to Flow?</span> <a
          class="inline-block font-medium underline hover:text-lime-600" href="#!">Create an account</a></p>
      <div class="container mx-auto px-4 relative">
        <div class="max-w-sm mx-auto">
          <form action="" method="POST">
            ...
            <label class="block pl-4 mb-1 text-sm font-medium" for="password">Password</label>
            <div class="relative mb-6" x-data="{ visible: false }">
              <input name="password" id="password"
                ...
                type="password" :type="visible ? 'text': 'password'" required />
              <a class="absolute top-1/2 right-0 transform -translate-y-1/2 mr-4" href="#!"
            ...
            <div class="text-right mb-10">
              <a class="inline-block text-sm underline font-medium" href="forgot_password.php">Forgot password?</a>
            </div>
            ...
            <span class="block text-center py-4 mx-auto text-gray-700">or</span>

            <a class="inline-flex w-full py-3 px-6 items-center justify-center text-lg font-medium text-black hover:text-white border border-teal-900 hover:bg-black rounded-full transition duration-200"
              href="#!">
                ...
                <div class="flex flex-wrap items-center -mx-4">
                  <div class="w-full lg:w-2/3 px-4 mb-8 lg:mb-0">
                    <div class="max-w-md xl:max-w-none">
                      <h1 class="font-heading text-4xl xs:text-5xl sm:text-6xl tracking-sm text-white mb-6">Small
                        actions can make a big difference for the planet</h1>
                      <p class="text-lg text-white opacity-80">Visit www.ecomind store to a better live</p>
                    </div>
                  </div>
                  <div class="w-full lg:w-1/3 px-4 lg:text-right"><a
                      class="inline-flex py-4 px-6 items-center justify-center text-lg font-medium text-teal-900 border border-lime-500 hover:border-white bg-lime-500 hover:bg-white rounded-full transition duration-200"
    ...
    <section class="relative py-12 lg:py-24 bg-orange-50 overflow-hidden"><img class="absolute bottom-0 left-0"
      ...
      <div class="container px-4 mx-auto relative">
        <div class="flex flex-wrap mb-16 -mx-4">
          <div class="w-full lg:w-2/12 xl:w-2/12 px-4 mb-16 lg:mb-0"><a class="inline-block mb-4" href="#!"><img
          ...
          <div class="w-full md:w-7/12 lg:w-6/12 px-4 mb-16 lg:mb-0">
            <div class="flex flex-wrap -mx-4">
              <div class="w-1/2 xs:w-1/3 px-4 mb-8 xs:mb-0">
                ...
                <ul>
                  <li class="mb-4"><a class="inline-block text-gray-600 hover:text-lime-500 font-medium"
                      href="#!">Solutions</a></li>
                  <li class="mb-4"><a class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#!">How
                      it works</a></li>
              ...
              <div class="w-1/2 xs:w-1/3 px-4 mb-8 xs:mb-0">
                ...
                <ul>
                  <li class="mb-4"><a class="inline-block text-gray-600 hover:text-lime-500 font-medium"
                      href="#!">Blog</a></li>
                  <li class="mb-4"><a class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#!">Help
                      Center</a></li>
              ...
              <div class="w-full xs:w-1/3 px-4">
                ...
                <ul>
                  <li class="mb-4"><a class="inline-block text-gray-600 hover:text-lime-500 font-medium"
                      href="#!">About</a></li>
                  <li class="mb-4"><a class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#!">Our
                      Mission</a></li>
                  <li class="mb-4"><a class="inline-block text-gray-600 hover:text-lime-500 font-medium"
                      href="#!">Careers</a></li>
            ...
            <div class="max-w-sm p-8 bg-teal-900 rounded-2xl mx-auto md:mr-0">
              ...
              <div class="flex flex-col">
                <input
                  ...
                  type="email" placeholder="Your e-mail..." /><a
        ...
        <div class="flex flex-wrap -mb-3 justify-between">
          ...
          <div class="text-center">Created by <a class="inline-block text-gray-600 hover:text-lime-500 font-medium"
              href="https://www.pixelrocket.store" target="_blank">Pixelrocket</a><span> • Distributed by </span><a
              class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="https://www.ThemeWagon.store"

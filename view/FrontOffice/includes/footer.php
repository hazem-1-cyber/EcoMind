    <!-- Footer -->
    <section class="relative py-12 lg:py-24 bg-orange-50 overflow-hidden" style="background-color: #fff7ed;">
      <div class="container px-4 mx-auto relative">
        <div class="flex flex-wrap mb-16 -mx-4">
          ...
          <div class="w-full md:w-10/12 lg:w-10/12 px-4 mb-16 lg:mb-0">
            <div class="flex flex-wrap -mx-4">
              <div class="w-1/2 xs:w-1/3 px-4 mb-8 xs:mb-0">
                ...
                <ul>
                  ...
                  <li><a class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="addDon.php">Faire un don</a></li>
                </ul>
              </div>
              ...
              <div class="w-1/2 xs:w-1/3 px-4 mb-8 xs:mb-0">
                ...
                <ul>
                  ...
                  <li><a class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="consulterdonpersonnel.php">Support</a></li>
                </ul>
              </div>
              ...
              <div class="w-full xs:w-1/3 px-4">
                ...
                <ul>
                  ...
                  <li class="mb-4"><a class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="addDon.php">Donations</a></li>
                  <li><a class="inline-block text-gray-600 hover:text-lime-500 font-medium" href="consulterdonpersonnel.php">Contact</a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div class="flex flex-wrap -mb-3 justify-between items-center">
          <div class="flex items-center mb-3">
            <a class="inline-block mr-4 text-black hover:text-lime-500" href="#!" style="color: #000;">
            ...
            <a class="inline-block text-black hover:text-lime-500" href="#!" style="color: #000;">
              <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="text-center mb-3">
            <p class="text-sm text-gray-600">© 2025 <strong>EcoMind</strong>. All rights reserved.</p>
          </div>
          <p class="text-sm text-gray-500 mb-3">Created with ❤️ for the planet</p>
        </div>
      </div>
    </section>
  </div>

...
$cat = $categorieCtrl->showCategorie($id);

if (!$cat) {
    header('Location: listcategorie.php?error=not_found');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($categorieCtrl->updateCategorie($categorie, $id)) {
...
<head>
    ...
    <title>Modifier une Catégorie - EcoMind BackOffice</title>
            ...
            <form method="POST" action="" class="modern-form">
                ...
                <div class="form-group-modern full">
                    ...
                    <input type="text" id="code" name="code" class="input-modern"
                           ...
                           value="<?= htmlspecialchars($_POST['code'] ?? $cat['code']) ?>">
                ...
                <div class="form-group-modern full">
                    ...
                    <textarea id="description" name="description" rows="5" class="input-modern"
                              placeholder="Description de la catégorie..."><?= htmlspecialchars($_POST['description'] ?? $cat['description']) ?></textarea>
                </div>

<?php
// search_inscriptions.php - Recherche avancée des inscriptions
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <title>EcoMind - Recherche Inscriptions</title>
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-dropdown active" id="searchDropdown">
                ...
                <div class="nav-dropdown-content">
                    ...
                    <a href="<?= BASE_URL ?>/index.php?page=search_inscriptions" class="nav-sub-item active">
                        <i class="fas fa-users"></i>
                        <span>Inscriptions</span>
                    </a>
    ...
    <div class="main-content">
        ...
        <div class="top-header">
            <div class="header-left">
                <h1><i class="fas fa-search"></i> Recherche Avancée - Inscriptions</h1>
            </div>
            <div class="header-right">
                <a href="<?= BASE_URL ?>/index.php?page=admin_inscriptions&add=1" class="header-icon" title="Ajouter une inscription">
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🚀 DOM loaded, initializing search for inscriptions');
    console.log('🚀 BASE_URL:', BASE_URL);
    console.log('🚀 API URL:', BASE_URL + '/api/search_simple.php');
    console.log('🚀 AdvancedSearch class available:', typeof AdvancedSearch);
    ...
    try {
        ...
        console.log('✅ AdvancedSearch initialized successfully');
    } catch (error) {
        console.error('❌ Failed to initialize AdvancedSearch:', error);
        alert('Error initializing search: ' + error.message);
    }

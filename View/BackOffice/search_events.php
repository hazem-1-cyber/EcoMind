<?php
// search_events.php - Recherche avancée des événements
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <title>EcoMind - Recherche Événements</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
    <link rel="stylesheet" href="<?= BASE_URL ?>/assets/css/back_style.css?v=<?= date('YmdHis') . microtime(true) . rand(10000,99999) ?>">
</head>
<body>
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-dropdown active" id="searchDropdown">
                ...
                <div class="nav-dropdown-content">
                    <a href="<?= BASE_URL ?>/index.php?page=search_events" class="nav-sub-item active">
                        <i class="fas fa-calendar-alt"></i>
                        <span>Événements</span>
                    </a>
    ...
    <div class="main-content">
        ...
        <div class="top-header">
            <div class="header-left">
                <h1><i class="fas fa-search"></i> Recherche Avancée - Événements</h1>
            </div>
            <div class="header-right">
                <a href="<?= BASE_URL ?>/index.php?page=admin_events&add=1" class="header-icon" title="Ajouter un événement">
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🚀 Initializing search for events');
...
<script src="<?= BASE_URL ?>/assets/js/advanced-search.js?v=<?= date('YmdHis') . microtime(true) . rand(10000,99999) ?>"></script>

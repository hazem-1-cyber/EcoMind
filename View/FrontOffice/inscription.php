...
<div class="container">
    <header>
        ...
        <p class="subtitle"><?= htmlspecialchars($event['titre']) ?></p>
    </header>
    ...
    <div class="tip-card">
        ...
        <form id="inscription-form" action="index.php?page=inscription&id=<?= $event['id'] ?>" method="post" onsubmit="return confirmInscription();">
